...
<style>
    ...
    .modal-dialog.modal-md button.close {
        opacity: 1;
        font-size: 45px;
        font-weight: 400;
        right: 15px;
...
<body class="hold-transition sidebar-mini layout-fixed">
                                    ...
                                    <div class="modal-dialog modal-xl"> <!-- You can change 'modal-xl' to your preferred width class -->
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 class="modal-title" style="margin: left 200px !important;">Add New Applicant </h4>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="exam-remark">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control " placeholder="Enter Remark" name="exam_remark" required></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="demo-remark">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" placeholder="Enter Remark" name="demo_lectures_remark" required></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" placeholder="Enter Sarchitnis Remark" name="remark" required> </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            foreach ($applicantlist as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-info" data-toggle="modal" data-target="#modal-edit<?php echo $row['id']; ?>">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
    ...
    <script>
        ...
        const nameInputField333 = document.getElementById('nameInputField333');
