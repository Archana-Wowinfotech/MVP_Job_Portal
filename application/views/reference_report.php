                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <h1 class="m-0">Reference Report</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <!-- <div class="text-right mb-4">
                        <a href="<?php echo base_url() . 'Institute_Report/toExcelReference'; ?>" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp; Export Excel</a>
                    </div> -->
                </div><!-- /.container-fluid -->
            </div>
            <!-- /.content-header -->
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($applicantlist as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><a href="<?php echo base_url() . 'reference-details/' . $row['reference_name']; ?>"><?php echo $row['reference_name']; ?></a></td>
                                                        <!-- <td>
                                                            <?php echo $row['other_reference_name']; ?>
                                                        </td>
