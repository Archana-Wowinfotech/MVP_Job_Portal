            ...
            <div class="content-header">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a href="<?php echo base_url() . 'Institute_Report/Reference_report'; ?>" class="back-button">
                    ...
                    <div class="text-right" id="excel-export-button" style="display:none;">
                        <a href="<?php echo base_url() . 'Report/toExcelReference/'.$reference_id; ?>" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp; Export Excel</a>
                    </div>
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table id="example2" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1;
                                                foreach ($reference_selected_applicant as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $row['reference_name']; ?></td>
                                                        <td><?php echo $row['other_reference_name']; ?></td>
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table id="example4" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1;
                                                foreach ($reference_inprocess_applicant as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $row['reference_name']; ?></td>
                                                        <td><?php echo $row['other_reference_name']; ?></td>
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table id="example5" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1;
                                                foreach ($reference_pending_applicant as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $row['reference_name']; ?></td>
                                                        <td><?php echo $row['other_reference_name']; ?></td>
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table id="example6" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1;
                                                foreach ($rejected_pending_applicant as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $row['reference_name']; ?></td>
                                                        <td><?php echo $row['other_reference_name']; ?></td>
...
foreach ($reference_report as $row1) {
?>
    <!-- Modal -->
