                                    ...
                                    <div class="card">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter Aadhar Number" maxlength="12" name="aadhar" id="aadhar" pattern="[0-9]{12}" title="Aadhar number must be 12 digits" onkeyup="NumbersOnly(this)">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="first_name" class="form-control" placeholder="Enter First Name" name="first_name" onkeyup="LettersOnly(this)">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" id="last_name" placeholder="Enter Last Name" name="last_name" onkeyup="LettersOnly(this)">
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" id="contact_no" placeholder="Enter Contact Number" name="contact_no" maxlength="10" pattern="[789][0-9]{9}" onkeyup="NumbersOnly(this)">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                        ...
                                                                        <select class="form-control" name="district_id" id="district_list">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            <label>Village *</label>
                                                                            <input type="text" class="form-control" id="city" placeholder="Enter Village Name" name="city">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="other_position" style="display: none;">
                                                                        <div class="form-group">
                                                                            <label for="name">Other Position</label>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="nameInputField12" style="display: none;">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" name="sabhasad_name" id="director_name" placeholder="Enter Director Name">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="nameInputField312" style="display: none;">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" name="name_director" id="director_name" placeholder="Enter Director Name">
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            &nbsp;&nbsp;
                                                                            <input type="radio" id="all" name="assign_to" value="all" checked>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="background" value="technical" required checked>
                                                                            <label for="tech">Technical</label>
                                                                            &nbsp;&nbsp;
                                                                            <input type="radio" id="nontech" name="background" value="nontechnical" required>
                                        ...
                                        <div class="card-body ">
                                            <form action="#" id="formSearch">
                                                <div id="example1_filter" class="dataTables_filter" style="text-align: center;">
                                                    <label>

                                                        <input type="search" class="form-control form-control-search-sm" placeholder="" aria-controls="example1" id="myInput">
                                                    </label>
                                                    <button type="button" class="btn btn-sm btn-primary" id="searchButton">Search</button>
                                                    <a href="<?php echo base_url() . 'Applicant/getApplicantByStatus/All'; ?>" class="btn btn-sm btn-primary" id="searchClear">Clear</a>
                                                </div>
                                            </form>
                                                        ...
                                                        ?>
                                                            ...
                                                            ?>
                                                                ...
                                                                <td class="text-center">
                                                                    <a href="<?php echo base_url() . 'certificate/' . $row['id'] . '/' . $row['candidate_id']; ?>">Add Document
                                                                </td>
                                                                <td>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-lg-4 col-md-64 col-sm-12 col-12">
                                                                                            <label for="education">Select Institute:</label>
                                                                                            <div class="form-group">
                                                                                                <input type="radio" id="schoolRadio11" name="institute_id" value="school" onclick="showFields1('school',<?php echo $i; ?>);" required>
                                                                                                <b> School </b>&nbsp;&nbsp;&nbsp;


                                                                                                <input type="radio" id="collegeRadio11" name="institute_id" value="college" onclick="showFields1('college',<?php echo $i; ?>);" <?php if ($row['institute_id'] == 'college') {
                                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                                } ?>>
                                                                                                <b> College </b>&nbsp;&nbsp;&nbsp;

                                                                                                <input type="radio" id="otherRadio11" name="institute_id" value="Professional-College" onclick="showFields1('Professional-College',<?php echo $i; ?>);" <?php if ($row['institute_id'] == 'Professional-College') {
                                                                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                                                                        } ?>>
                                                                                                <b>Professional College</b>
                                                                                            </div>
                                                                                        </div>

                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                                            <div id="selectmedium2_<?php echo $i; ?>" style="display: <?php if ($row['education'] != '') {
                                                                                                                                                            echo 'block';
                                                                                                                                                        } else {
                                                                                                                                                            echo 'none';
                                                                                                                                                        } ?>;">
                                                                                            ...
                                                                                            <div id="selectcollege2_<?php echo $i; ?>" style="display: <?php if ($row['college'] != '') {
                                                                                                                                                            echo 'block';
                                                                                                                                                        } else {
                                                                                                                                                            echo 'none';
                                                                                                                                                        } ?>">
                                                                                            ...
                                                                                            <div id="selectprof_<?php echo $i; ?>" style="display: <?php if ($row['professional'] != '') {
                                                                                                                                                        echo 'block';
                                                                                                                                                    } else {
                                                                                                                                                        echo 'none';
                                                                                                                                                    } ?>;">
                                                                                        ...
                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="nameInputField6_<?php echo $i; ?>" style="display:<?php if ($row['reference_id'] == '2') {
                                                                                                                                                                                                    echo "none";
                                                                                                                                                                                                } else {
                                                                                                                                                                                                    echo "block";
                                                                                                                                                                                                } ?>">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text" class="form-control" name="sabhasad_mobile_no" placeholder="Enter Sabhasad Mobile Number" maxlength="10" pattern="[789][0-9]{9}" onkeyup="NumbersOnly(this)" value="<?php echo $row['sabhasad_mobile_no']; ?>" id="name">
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="nameInputField7_<?php echo $i; ?>" style="display:<?php if ($row['reference_id'] == '2' || $row['reference_id'] == '1' || $row['reference_id'] == '4') {
                                                                                                                                                                                                    echo "none";
                                                                                                                                                                                                } else {
                                                                                                                                                                                                    echo "block";
                                                                                                                                                                                                } ?>">
                                                                                            <div class="form-group">
                                                                                                <label for="name">Director Name</label>
                                                                                                <input type="text" class="form-control" name="sabhasad_name" value="<?php echo $row['sabhasad_name']; ?>" id="name" placeholder="Enter Director Name">
                                                                                            </div>
                                                                                        </div>

                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="nameInputField852_" style="display:<?php if ($row['reference_id'] == '5' || $row['reference_id'] == '6') {
                                                                                                                                                                                    echo "block";
                                                                                                                                                                                } else {
                                                                                                                                                                                    echo "none";
                                                                                                                                                                                } ?>">
                                                                                            <div class="form-group">
                                                                                                <label for="name">Employee Unit Name</label>
                                                                                                <input type="text" class="form-control" value="<?php echo $row['name_director']; ?>" id="director_name" placeholder="Enter Employee Unit Name">
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                                            <div class="form-group">
                                                                                                <label for="exam">Assign To EO:</label><br>
                                                                                                <input type="radio" name="assign_to2" id="assign_to_<?php echo $i; ?>" value="eo" onclick="assign_to('eo',<?php echo $i; ?>);" <?php if ($row['assign_to'] == 'eo') echo 'checked'; ?>>
                                                                                                <label for="eo">Individual</label>
                                                                                                &nbsp;&nbsp;
                                                                                                <input type="radio" name="assign_to2" value="all" id="assign_to_<?php echo $i; ?>" onclick="assign_to('all',<?php echo $i; ?>);" <?php if ($row['assign_to'] == 'all') echo 'checked'; ?>>
                                                                                                <label for="all">All</label>
                                                                                            </div>
                                                                                        </div>

                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="eoDropdown_<?php echo $i; ?>" style="display: <?php if ($row['eo_id'] != '' && $row['assign_to'] == 'eo') {
                                                                                                                                                                                                echo 'block';
                                                                                                                                                                                            } else {
                                                                                                                                                                                                echo 'none';
                                                                                                                                                                                            } ?>;">
                                                                                        ...
                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                                            <div class="form-group">
                                                                                                <label for="exam">Exam:</label><br>
                                                                                                <input type="radio" id="done_exam_<?php echo $i; ?>" name="exam" value="done" onclick="show_remark('done',<?php echo $i; ?>);" <?php if ($row['exam'] === 'done') echo 'checked'; ?>>
                                                                                                <label for="done_exam">Done</label>

                                                                                                <input type="radio" id="not_done_exam_<?php echo $i; ?>" name="exam" value="not_done" onclick="show_remark('not_done',<?php echo $i; ?>);" <?php if ($row['exam'] === 'not_done') echo 'checked'; ?>>
                                                                                                <label for="not_done_exam">Not Done</label>

                                                                                                <!-- Additional Field for Exam Remark -->

                                                                                                <div id="examRemarkField_<?php echo $i; ?>" style="display: none;">
                                                                                        ...
                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="radio" id="done_demo_lectures_<?php echo $i; ?>" name="demo_lectures" value="done" onclick="show_demo_remark('done',<?php echo $i; ?>);" <?php if ($row['demo_lectures'] === 'done') echo 'checked'; ?>>
                                                                                                <label for="done_demo_lectures">Done</label>

                                                                                                <input type="radio" id="not_done_demo_lectures_<?php echo $i; ?>" name="demo_lectures" value="not_done" onclick="show_demo_remark('not_done',<?php echo $i; ?>);" <?php if ($row['demo_lectures'] === 'not_done') echo 'checked'; ?>>
                                                                                                <label for="not_done_demo_lectures">Not Done</label>

                                                                                                <!-- Additional Field for Demo Lectures Remark -->
                                                                                                <div id="demoLecturesRemarkField_<?php echo $i; ?>" style="display: none;">
        ...
        <div class="modal-dialog modal-xl">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="dvContents_<?php echo $j; ?>">
                        <table class="table table-bordered" style="border-width:2px;">

                            <tbody>
                                <h5 style="margin-left: 9px;"><b>Application ID : </b><?php echo $row1['id']; ?></h5>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="4" class="head-td">Position Details</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="4" class="head-td">Institute Details</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Institute :</td>
                                    <td><?php echo $row1['institute_id']; ?></td>
                                    <?php if ($row1['institute_id'] == 'school') {  ?>
                                ...
                                <tr>
                                    <td colspan="4" class="head-td">Reference Details</td>
                                </tr>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row1['sabhasad_name']; ?></td>
                                </tr>
                        ...
                        <div class="col-md-6 text-center p-1" style="border: 4px solid #026C7C;">
                            ...
                            <form method="post" action="<?php echo base_url() . 'Applicant/updateStatusRemark'; ?>">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="position_id" value="<?php echo $row1['position_id']; ?>">
                                </div>
                                <div class="form-group" style="margin-bottom: 0; margin:0px 20px 0px 20px;">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1" name="status">
                                        ...
                                        <option value="Referred_to" <?php if ($row1['status'] == 'Referred_to') {
                                                                        echo 'Selected';
                                                                    } else {
                                                                        echo '';
                                                                    } ?>>Referred To</option>
                                    ...
                                    <textarea id="additional_details" name="status_remark" placeholder="Enter Remark" style="margin: 15px 0; width: 100%; padding: 5px; border-radius: 5px; outline: 0; border: 1px solid #d1d1d1;"></textarea>
...
<script>
    function showFields1(instituteType, id) {
        var v1 = 'selectmedium2_' + id;
        var v2 = 'selectcollege2_' + id;
        var v3 = 'selectprof_' + id;
...
<script>
    function printBasicDiv(divId) {
        var printBasicContents = document.getElementById(divId).outerHTML;
        ...
        printWindow.document.write(printBasicContents);
...
<script>
    function assign_to(eoRadio, id) {
        //alert(eoRadio);
        var eoRadio1 = eoRadio;
        var v1 = "eoDropdown_" + id;

        // var eoDropdown = document.getElementById(v1);
        if (eoRadio1 == 'eo') {
            document.getElementById(v1).style.display = 'block';
        } else {
            document.getElementById(v1).style.display = 'none';
    ...
    function show_remark(val, id) {

        var v1 = "examRemarkField_" + id;
    ...
    function show_demo_remark(val, id) {

        var v1 = "demoLecturesRemarkField_" + id;
...
<script>
    $(document).ready(function() {
        // Attach a click event to a button (or any element) to trigger the AJAX request
        $('#aadhar').change(function() {
            var textbox = document.getElementById("aadhar");
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() . 'Applicant/getCandidateDetailsByAadhar'; ?>',
                data: {
                ...
                success: function(data) {
                    {
                        ...
                        for (i = 0; i < jsonArray.length; i++) {
                            ...
                            var first_name = jsonArray[i].first_name;
                            var last_name = jsonArray[i].last_name;
                            var aadharno = jsonArray[i].aadhar;
                            var contact_no = jsonArray[i].contact_no;
                            var email_id = jsonArray[i].email_id;
                            var city = jsonArray[i].city;
                            var taluka_id = jsonArray[i].taluka_id;
                            var taluka_name = jsonArray[i].taluka_name;
                            var district_id = jsonArray[i].district_id;
                            var district_name = jsonArray[i].district_name;

                            var option = $('<option>');

                            // Set the value attribute to the city ID
                            option.val(taluka_id);

                            // Set the text content of the option to the city name
                            option.text(taluka_name);

                            var option1 = $('<option>');

                            // Set the value attribute to the city ID
                            option1.val(district_id);

                            // Set the text content of the option to the city name
                            option1.text(district_name);
                            ...
                            $("#city").val(city);
                            // $("#taluka_list").append(option);
                            // $("#district_list").append(option1);

                        }
                        // $("#district_list option:lt(<?php //echo count($district); 
                                                        ?>)").hide();
...
<script>
    jQuery("#searchButton").on("click", function() {
        ...
        $.ajax({
            url: '<?php echo base_url() . 'Applicant/search_applicant'; ?>',
            method: 'post',
            data: {
                val: val
            },
            success: function(data) {
                ...
                //      alert(parsedData); // Display the parsed data in an alert
                ...
                $.each(parsedData, function(index, item) {
                    ...
                    var newRow = '<tr>' +
                        ...
                        // '<td><a href="' + base_url() + 'certificate/' + item.id + '" target="_blank">Add Document</a></td>'
                        '<td>' + ' ' + '</td>' +
                        '<td>' + item.eo_name + '</td>' +
                        '<td>' + item.status + '</td>' +
                        '<td><a class="btn btn-success" data-toggle="modal" data-target="#modal-viewData' + item.id + '"><i class="fas fa-eye"></i></a><a class="btn btn-info" data-toggle="modal" data-target="#modal-edit' + item.id + '"><i class="fas fa-edit"></i></a></td>' +
...
<!-- <script>
    function showInputField(status) {
        var selectedStatus = $("#exampleFormControlSelect1").val();

        // Access the passed PHP variable (id) here and use it as needed
        console.log("ID from PHP:", status);
        // $("#referredToInput_"+status).hide();
        if (status === "Refered_to") {
            $("#referredToInput").show();
        } else {
            $("#referredToInput").hide();
        }
    }
</script> -->
