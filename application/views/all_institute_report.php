        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-2">
                            <a href="<?php echo base_url() . 'Institute_Report/index'; ?>" class="back-button">
                        ...
                        <div class="col-sm-8">
                        <?php $in_id = $this -> uri -> segment(2); ?>
                      <?php  $gettype = $this -> Report_Model -> getInstitute_type($in_id);
                            if(count($gettype) > 0 ){
                                foreach($gettype as $k1){
                            ...
                            ?>
                            <h1 class="m-0" style="color:mediumvioletred;">
                                <td>
                    ...
                    <div class="text-right" id="excel-export-button" style="display:none;">
                        <a href="<?php echo base_url() . 'Report/toExcel/'.$in_id; ?>" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp; Export Excel</a>
                    </div>
                </div><!-- /.container-fluid -->
            </div><br>
            <!-- /.content-header -->
                ...
                <div class="container-fluid">
                    <div class="content-section">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-pending-tab" data-toggle="pill" href="#pills-pending" role="tab" aria-controls="pills-pending" aria-selected="true">Pending</a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1;
                                                foreach ($institute_applicant as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table id="example2" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1;
                                                foreach ($institute_selected_applicant as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <!-- <a data-toggle="modal" data-target="#modal-edit<?php echo $row['id']; ?>" style="color: blue;"> -->
                                                        <td>
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table id="example4" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1;
                                                foreach ($institute_inprocess_applicant as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <!-- <a data-toggle="modal" data-target="#modal-edit<?php echo $row['id']; ?>" style="color: blue;"> -->
                                                        <td>
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table id="example5" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1;
                                                foreach ($institute_pending_applicant as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <!-- <a data-toggle="modal" data-target="#modal-edit<?php echo $row['id']; ?>" style="color: blue;"> -->
                                                        <td>
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table id="example6" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1;
                                                foreach ($institute_rejected_applicant as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <!-- <a data-toggle="modal" data-target="#modal-edit<?php echo $row['id']; ?>" style="color: blue;"> -->
                                                        <td>
...
foreach ($institute_applicant as $row1) {
?>
    <!-- Modal -->
