...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <a href="<?php echo base_url() . 'Applicant/getallApplicant'; ?>" class="back-button">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="selectmedium" style="display: none;">
                                                                        <div>
                                                                            ...
                                                                            <select class="form-control" id="subEducation" name="education">
                                                                                ...
                                                                                <option value="Marathi">Marathi Medium School</option>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="nameInputField" style="display: none;">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" name="other_reference_name" id="name" placeholder="Enter Name" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="nameInputField12" style="display: none;">
                                                                        <div class="form-group">
                                                                            <label for="director_name">Director Name</label>
                                                                            <input type="text" class="form-control" name="sabhasad_name" id="name_director" placeholder="Enter Director Name">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <!-- <div id="nameInputField12">
                                                                         <input type="text" name="name_director_test">
                                                                      </div> -->
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="nameInputField312" style="display: none;">
                                                                        <div class="form-group">
                                                                            <label for="employee_name">Employee Unit Name</label>
                                                                            <input type="text" class="form-control" name="name_director" id="name_director" placeholder="Enter Director Name">
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        ?>
                                                            ...
                                                            ?>
                                                                ...
                                                                <td class="text-center">
                                                                    <a href="<?php echo base_url() . 'certificate/' . $row['id'] . '/' . $candidate_id; ?>">Add Document
                                                                </td>
                                                                <td>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-lg-4 col-md-64 col-sm-12 col-12">
                                                                                            <label for="education">Select Institute:</label>
                                                                                            <div class="form-group">
                                                                                                <input type="radio" id="schoolRadio11" name="institute_id" value="school" onclick="showFields1('school',<?php echo $i; ?>);" required <?php if ($row['institute_id'] == 'school') {
                                                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                                                        } ?>>
                                                                                                <b> School </b>&nbsp;&nbsp;&nbsp;
                                                                                        ...
                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="nameInputField4_<?php echo $i; ?>" style="display:<?php if ($row['reference_id'] == '2' || $row['reference_id'] == '5' || $row['reference_id'] == '6') {
                                                                                                                                                                                                } ?>">
                                                                                            <div class="form-group">
                                                                                                <label for="relation">Relation</label>
                                                                                                <select class="form-control" name="relation" id="relation">
                                                                                        ...
                                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="eoRadio1<?php echo $i; ?>" style="display: <?php if ($row['eo_id'] != '' && $row['assign_to'] == 'eo') {
                                                                                                                                                                                            echo 'block';
                                                                                                                                                                                        } else {
                                                                                                                                                                                            echo 'none';
                                                                                                                                                                                        } ?>;">
    ...
    <script>
        function hide_ref(selectedValue, id) {
            ...
            var nameInputField852 = document.getElementById("nameInputField852_" + id);
            ...
            if (selectedValue === '1') {
                ...
                nameInputField852.style.display = 'none';
                ...
                nameInputField6.style.display = 'block';
                nameInputField7.style.display = 'none';
                nameInputField852.style.display = 'block';
    ...
    <script>
        ...
        referenceDropdown.addEventListener('change', function() {
            if (referenceDropdown.value !== '') {
                ...
                } else if (referenceDropdown.value == '6') {
                    nameInputField.style.display = 'block';
                    nameInputField2.style.display = 'block';
                    nameInputField3.style.display = 'block';
                    nameInputField312.style.display = 'block';
